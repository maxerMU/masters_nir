...
{Классификация методов виртуализации программного обеспечения} % Тема работы
{Мицевич~М.~Д./ИУ7-13М} % Номер группы/ФИО студента (если авторов несколько, их необходимо разделить запятой)
